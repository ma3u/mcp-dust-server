...
/**
 * Multi-instance development server launcher for MCP-Dust server
 * Uses the existing npm scripts to avoid module resolution issues
 */
...
/**
 * Start a single MCP server instance using npm run dev:server
 * 
...
function startInstance(index) {
  return new Promise((resolve) => {
    ...
    // Use npm run dev:server which is already configured correctly
